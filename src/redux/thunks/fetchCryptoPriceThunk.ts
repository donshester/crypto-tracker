...
export const fetchCryptoPrice = (): ThunkAction<void, {}, {}, Action<string>> => async (dispatch) => {
    ...
    try{
        ...
        const chartData:ICryptoPriceData[] = responseArr.map(({date,priceUsd}) => ({date, priceUsd}));

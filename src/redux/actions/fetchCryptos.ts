import { FETCH_COIN_DATA_ERROR, FETCH_COIN_DATA_REQUEST, FETCH_COIN_DATA_SUCCESS } from '../constants';
...
export type FetchCoinsActions = FetchCoinsRequestAction | FetchCoinsSuccessAction | FetchCoinsErrorAction;
